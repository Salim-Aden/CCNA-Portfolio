...
Each lab is configured and verified using Cisco IOS CLI in Packet Tracer, with full topology diagrams, configurations, and verification outputs included.
...
| 02 |OSPF — Single & Multi-Area]| Four routers running OSPFv2 across Area 0 and Area 1, with R3 as the ABR enabling dynamic route exchange between all segments |
